...
namespace App::Controllers {
    ...
    void Users_Controller::RegisterRoutes(crow::App<CORS>& app) {
        ...
        CROW_ROUTE(app, "/set/friend/user/id").methods(crow::HTTPMethod::Post)([JWT, AES](const crow::request& req) {
            ...
            try {
                ...
                std::string encrypted_friend_id = body["friend_id"].s();
        ...
        CROW_ROUTE(app, "/get/all/friends/ids").methods(crow::HTTPMethod::Post)([JWT,AES](const crow::request& req) {
            auto body = crow::json::load(req.body);
        ...
        CROW_ROUTE(app, "/delete/friend/user/id").methods(crow::HTTPMethod::Post)([JWT, AES](const crow::request& req) {
            auto body = crow::json::load(req.body);
            ...
            if (!body ||
                ...
                !body.has("token") ||
                !body.has("friend_id")) {
                return crow::response(400, "Error: 1"); // Missing data
            }
